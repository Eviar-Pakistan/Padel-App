...
function Avatar({ user, accepted }) {
  return (
    <div className="relative mx-auto h-12 w-12">
      ...
      {accepted && (
        <span className="absolute -bottom-[-6px] -right-[-6px] flex h-3 w-3 items-center justify-center rounded-full bg-[var(--color-primary)] text-[var(--color-background)]">
...
export default function MatchCard({
  ...
  return (
    <article className="overflow-hidden rounded-[1.6rem] border border-white/10 bg-[var(--color-background)] p-3.5">
